...
dependencies {
  ...
  /**
   * sentryOpentelemetryBootstrap cannot be an implementation dependency because
   * getSentryOpentelemetryCore is loaded into the agent classloader and
   * sentryOpentelemetryBootstrap should be in the bootstrap classloader.
   */
