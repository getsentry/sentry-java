...
final class SendCachedEnvelopeIntegration implements Integration {
  ...
  private final @NotNull SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForgetFactory factory;
  ...
  @Override public void register(@NotNull IHub hub, @NotNull SentryOptions options) {
    ...
    final SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForget
      sender = factory.create(hub, androidOptions);
