...
internal class JsonObjectSerializerTest {
  ...
  fun `serialize map`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, mapOf("fixture-key" to "fixture-value"))
  ...
  fun `serialize map of enum`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, mapOf("key" to DataCategory.Transaction))
    verify(fixture.writer).beginObject()
  ...
  fun `serialize object with enum property`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, ClassWithEnumProperty(DataCategory.Attachment))
    verify(fixture.writer).beginObject()
  ...
  fun `serialize unknown object with data`() {
    val objectWithPrimitiveFields = UnknownClassWithData(17, "fixtureString")
  ...
  fun `serializing AtomicIntegerArray`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, AtomicIntegerArray(arrayOf(1, 2, 3).toIntArray()))
    verify(fixture.writer).beginArray()
  ...
  fun `serializing URI`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, URI("http://localhost:8081/api/product?id=99"))
  ...
  fun `serializing UUID`() {
    fixture
      .getSUT()
      .serialize(fixture.writer, fixture.logger, "828900a5-15dc-413f-8c17-6ef04d74e074")
  ...
  class UnknownClassWithData(private val integer: Int, private val string: String)
}
