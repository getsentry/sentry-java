...
class NoOpTransactionProfilerTest {
  ...
  @Test fun `start does not throw`() = profiler.start()

  @Test fun `bindTransaction does not throw`() = profiler.bindTransaction(mock())
  ...
  @Test fun `close does not throw`() = profiler.close()
}
