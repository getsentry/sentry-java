...
// and having a processor which is the common fields and specific processors for Event and
// Transactions
// not sure if our event processor interface should be deal with this
// the downside using only the base class, if people want to process a field which is not part of
// SentryBaseEvent
