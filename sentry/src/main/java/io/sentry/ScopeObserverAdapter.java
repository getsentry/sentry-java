...
public abstract class ScopeObserverAdapter implements IScopeObserver {
  @Override public void setUser(@Nullable User user) {}
  ...
  @Override public void setTag(@NotNull String key, @NotNull String value) {}

  @Override public void removeTag(@NotNull String key) {}

  @Override public void setTags(@NotNull Map<String, @NotNull String> tags) {}

  @Override public void setExtra(@NotNull String key, @NotNull String value) {}

  @Override public void removeExtra(@NotNull String key) {}
