...
final class DisabledSentryClient implements ISentryClient {

  private static final DisabledSentryClient instance = new DisabledSentryClient();

  private DisabledSentryClient() {}

  public static DisabledSentryClient getInstance() {
    return instance;
  }
