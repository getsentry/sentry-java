...
import io.sentry.protocol.jfr.jfr.event.AllocationSample;
...
public final class JfrToFlame extends JfrConverter {
            ...
            if (stackTrace != null) {
              ...
              if (classId != 0) {
                stack.push(
                    ...
                    (event instanceof AllocationSample) && ((AllocationSample) event).tlabSize == 0
                        ? TYPE_KERNEL
                        : TYPE_INLINED);
              }
