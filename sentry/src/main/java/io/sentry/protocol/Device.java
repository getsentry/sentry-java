...
public final class Device implements JsonUnknown, JsonSerializable {
  ...
  @Override public int hashCode() {
    int result =
      Objects.hash(name, manufacturer, brand, family, model, modelId, batteryLevel, charging,
        online, orientation, simulator, memorySize, freeMemory, usableMemory, lowMemory,
        storageSize, freeStorage, externalStorageSize, externalFreeStorage, screenWidthPixels,
        screenHeightPixels, screenDensity, screenDpi, bootTime, timezone, id, language, locale,
        connectionType, batteryTemperature);
