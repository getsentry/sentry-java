...
.. sourcecode:: groovy
    ...
    compile 'io.sentry:sentry-log4j2:1.7.1'

Using SBT:

.. sourcecode:: scala

    libraryDependencies += "io.sentry" % "sentry-log4j2" % "1.7.1"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-log4j2%7C1.7.1%7Cjar>`_.
