...
.. sourcecode:: scala
    ...
    libraryDependencies += "io.sentry" % "sentry" % "1.5.0"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry%7C1.5.0%7Cjar>`_.
