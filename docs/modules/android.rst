...
Adding version ``8.0.1`` of the Android SDK to a sample application that doesn't even use
...
For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Ccom.getsentry.raven%7Craven-android%7C8.0.1%7Cjar>`_.
