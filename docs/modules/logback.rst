...
.. sourcecode:: scala
    ...
    libraryDependencies += "io.sentry" % "sentry-logback" % "1.7.1"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-logback%7C1.7.1%7Cjar>`_.
