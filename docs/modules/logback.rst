...
.. sourcecode:: scala
    ...
    libraryDependencies += "io.sentry" % "sentry-logback" % "1.4.0"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-logback%7C1.4.0%7Cjar>`_.
