...
.. sourcecode:: groovy
    ...
    compile 'io.sentry:sentry-log4j:1.6.5'

Using SBT:

.. sourcecode:: scala

    libraryDependencies += "io.sentry" % "sentry-log4j" % "1.6.5"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-log4j%7C1.6.5%7Cjar>`_.
