...
.. sourcecode:: groovy
    ...
    compile 'io.sentry:sentry-log4j:1.5.3'
...
For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-log4j%7C1.5.3%7Cjar>`_.
