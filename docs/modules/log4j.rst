...
.. sourcecode:: groovy
    ...
    compile 'io.sentry:sentry-log4j:1.7.0'

Using SBT:

.. sourcecode:: scala

    libraryDependencies += "io.sentry" % "sentry-log4j" % "1.7.0"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-log4j%7C1.7.0%7Cjar>`_.
