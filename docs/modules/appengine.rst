...
.. sourcecode:: groovy
    ...
    compile 'io.sentry:sentry-appengine:1.5.2'

Using SBT:

.. sourcecode:: scala

    libraryDependencies += "io.sentry" % "sentry-appengine" % "1.5.2"

For other dependency managers see the `central Maven repository <https://search.maven.org/#artifactdetails%7Cio.sentry%7Csentry-appengine%7C1.5.2%7Cjar>`_.
