...
public final class SentryOpenFeatureHook implements BooleanHook {
  ...
  @Override
    public void after(final @Nullable HookContext<Boolean> context, final @Nullable FlagEvaluationDetails<Boolean> details, final @Nullable Map<String, Object> hints) {
      if (context == null || details == null) {
        ...
        try {
          ...
          final @Nullable FlagValueType type = context.getType();
            ...
            scopes.getOptions().getLogger().log(
                SentryLevel.ERROR,
                "Failed to capture feature flag evaluation",
                e
            );
        }
    }
