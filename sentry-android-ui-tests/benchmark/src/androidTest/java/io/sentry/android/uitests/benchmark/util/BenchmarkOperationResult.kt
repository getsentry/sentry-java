...
internal data class BenchmarkOperationResult(
    ...
    fun compare(other: BenchmarkOperationResult): BenchmarkOperationComparison {
        ...
        println("Measuring the increased cpu time. It has no direct impact on performance of the app, " +
        ...
        println("Measuring the increased fps drop rate. Very important, as it weights dropped frames based on the " +
