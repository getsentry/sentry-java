...
- Hints are now used via aHints object and passed into beforeSend and EventProcessor as @NotNull Hints object ([#2045]https://github.com/getsentry/sentry-java/pull/2045)
