...
- Fix SDK callback error handling ([#6140](https://github.com/getsentry/sentry-java/pull/6140))
  ...
  - When `tracesSampler` throws, inherit the parent sampling decision or leave the trace unsampled if there is no parent decision, instead of falling back to `tracesSampleRate`.
