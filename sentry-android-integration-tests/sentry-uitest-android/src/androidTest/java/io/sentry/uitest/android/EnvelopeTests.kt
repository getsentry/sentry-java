        ...
        .assert {
          ...
          profilingTraceData.measurementsMap.entries
            ...
            .forEach { entry ->
              ...
              //  since when the transaction finishes, the frame callback is removed from the
              // activity,
              ...
              if (
                ...
                // Due to the nature of frozen frames, they could be measured after the transaction
                // finishes
                assertTrue(
          ...
          // We should find the transaction id that started the profiling in the list of
          // transactions
          val transactionData =
            profilingTraceData.transactions.firstOrNull { t ->
              t.id == transaction.eventId.toString()
            }
