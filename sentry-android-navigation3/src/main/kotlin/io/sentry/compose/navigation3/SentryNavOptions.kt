...
/** Configuration for [rememberSentryNavEntryDecorator] instrumentation. */
...
public class SentryNavOptions {
  ...
  // TODO ADAM: Make sure we can handle 0 appropriately + adequately protect against negative
  //  values. Update KDoc accordingly.
  /**
